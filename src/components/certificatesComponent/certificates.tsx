      ...
      <div className={cl.container}>
        <ContentCard width="400px" className={cl.certificateCard}>
          ...
          <Typography variant="body2" style={{ hyphens: "auto" }}>
            Протягом дня з моменту успішної оплати ми надішлемо ваш подарунковий
            сертифікат в електронному вигляді (формат .pdf та .png). Разом із
            ...
            переглянути натиснувши зверху на картинці!
          </Typography>
        </ContentCard>
        ...
        <ContentCard width="400px" className={cl.certificateCard}>
          ...
          >
            Ми друкуємо іменні сертифікати з високоякісного щільного паперу,
