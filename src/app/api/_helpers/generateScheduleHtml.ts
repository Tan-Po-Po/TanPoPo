...
export const generateScheduleHtml = (formData: Data) => {
  return `<html lang="en">
  <head>
    <style>
      body {
  ...
  <body>
    <h1 style="white-space: pre-line">
      Вітаємо! Дякуємо за Ваш \nзаповнений розклад навчання!
    </h1>
    <img class="img" src="cid:school" width="160px" height="137px" />
    <p style="font-size: 16px">
      Незабаром ми сконтактуємось з Вами, щоб узгодити всі деталі!
    </p>
    <div class="card contact">
      <h1><b>Заповнена інформація:</b></h1>
      ...
      ${
        formData.contact
          ? `
        <h1 style="margin-top: 20px">Контактна особа</h1>
