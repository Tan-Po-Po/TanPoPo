  ...
  <body>
    ...
    <div class="card" style="max-width: 650px">
      ...
      <p style="white-space: pre-line">
        Якщо Ви ще не оплачували подарунковий сертифікат,<br>це можна зробити за нашими реквізитами або за<br>допомогою швидкої оплати по QR-коду нашої школи!
      </p>
      ...
      <p style="white-space: pre-line">
        Протягом дня з моменту успішної оплати <br>ми надішлимо ваш електронний подарунковий <br>сертифікат та промокод для активації курсу!
      </p>
    </div>
