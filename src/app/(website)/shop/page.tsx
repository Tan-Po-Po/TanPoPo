...
export const metadata: Metadata = {
  title: "Японські флеш-картки | Швидкісне вивчення ієрогліфів",
  description:
    "Мнемонічні картки для швидкісного вивчення канджі/ієрогліфів. Авторські японські навчальні продукти. Подарункові сертифікати з японської мови та інше!",
};
